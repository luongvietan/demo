    ...
    >
      ...
      >
        <div className="flex flex-col items-center text-center">
          <div className="inline-flex items-center px-3 py-1 mb-8 text-sm font-medium rounded-full bg-neutral-100 dark:bg-neutral-800 text-neutral-800 dark:text-neutral-200">
            <span className="flex h-2 w-2 mr-2 rounded-full bg-emerald-500" />
            Premium Web Development Solutions
          </div>

          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-neutral-950 to-neutral-800 dark:from-white dark:to-neutral-300">
            Premium Web Solutions for <br />
            <span className="text-emerald-500">Modern</span> Businesses
          </h1>

          <div className="text-xl md:text-2xl font-medium mb-8 text-neutral-700 dark:text-neutral-300 h-8">
            We create beautiful{" "}
            <TypingAnimation
              words={words}
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-16">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 rounded-md bg-gradient-to-r from-emerald-500 to-cyan-500 text-white font-medium flex items-center justify-center hover:shadow-lg transition-shadow"
            >
              Request a Quote
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 rounded-md border border-neutral-300 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300 font-medium hover:bg-neutral-100 dark:hover:bg-neutral-800 transition-colors"
            >
              View Our Work
            </motion.a>
          </div>
          ...
          <div className="relative w-full max-w-5xl mx-auto mt-8 shadow-2xl rounded-lg overflow-hidden border border-neutral-200 dark:border-neutral-800">
